                                    ...
                                    <div class="card-body">
                                        ...
                                        <form  class="forms-sample" action="../controller/UserController.php" method="POST">
                                           <div class="form-group">
                                                ...
                                                <input type="text" readonly value="<?php echo $data["user_info"]["ID"]; ?>" class="form-control p-input" id="txt_userid" name="txt_userid" placeholder="UserID">
                                            </div>
                                            <div class="form-group">
                                                <label for="exampleInputUserName1">User name</label>
                                                <input type="text" value="<?php echo $data["user_info"]["username"]; ?>" class="form-control p-input" id="txt_username" name="txt_username" placeholder="UserName">
                                            </div>
                                            <div class="form-group">
                                                <label for="exampleInputEmail1">Email address</label>
                                                <input type="email"  disabled value="<?php echo $data["user_info"]["email"]; ?>" class="form-control p-input" id="txt_email" name="txt_email" aria-describedby="emailHelp" placeholder="Enter email">
                                                <small id="emailHelp" class="form-text text-muted text-success"><span class="fa fa-info mt-1"></span></small>
                                            </div>
                                            <div class="form-group">
                                                <label for="exampleInputPassword1">Password</label>
                                                <input type="password" class="form-control p-input" id="txt_password" name="txt_password" placeholder="Set a new Password">
                                            </div>
                                            <div class="form-group">
                                                <label for="exampleTextarea">Bio</label>
                                                <textarea class="form-control p-input" id="txt_bio" name="txt_bio" rows="3"><?php echo $data["user_info"]["bio"]; ?></textarea>
                                            </div>
<!--                                            <div class="form-group">
...
<!--                                            <fieldset class="form-group">
                                            ...
                                            <div class="col-12">
                                                <input type="submit" name="user_action" class="btn btn-primary" value="postedit">
